...
PD_flow_ros::PD_flow_ros(unsigned int cam_mode_config, unsigned int fps_config, unsigned int rows_config)
{     
...
void PD_flow_ros::createImagePyramidGPU()
{
...
void PD_flow_ros::solveSceneFlowGPU()
{
    //Define variables
    CTicTac	clock;
...
void PD_flow_ros::CloseCamera()
{
    rgb.destroy();
    openni::OpenNI::shutdown();
}

void PD_flow_ros::CaptureFrame()
{
...
void PD_flow_ros::freeGPUMemory()
{
    csf_host.freeDeviceMemory();
}

void PD_flow_ros::initializeCUDA()
{
    //Read parameters
...
void PD_flow_ros::initializeScene()
{
...
void PD_flow_ros::initializePDFlow()
{
